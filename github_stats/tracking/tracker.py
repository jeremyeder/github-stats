...
from ..constants import LOG_MESSAGES, ERROR_MESSAGES
...
class InteractionTracker:
    ...
    def _track_with_error_handling(
        ...
        try:
            ...
            error_msg = ERROR_MESSAGES.get("api_request_failed", "Failed to track {operation}: {error}")
    ...
    def _log_tracking_result(self, operation_name: str, count: int, owner: str, repo: str) -> None:
        """Log tracking result in standardized format."""
        message = LOG_MESSAGES.get("interactions_tracked", "Tracked {count} {interaction_type} for {repo}")
