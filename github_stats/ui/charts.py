...
class ChartGenerator:
    ...
    def get_interactions_data(self, filters: dict | None = None) -> pd.DataFrame:
        ...
        for interaction in interactions:
            data.append({
                ...
                'repository_name': interaction.repository.full_name if interaction.repository else None,
                'organization_name': interaction.organization.name if interaction.organization else None,
    ...
    def create_time_series_chart(self, df: pd.DataFrame, groupby: str = 'date') -> go.Figure:
    ...
    def create_stacked_bar_chart(self, df: pd.DataFrame, groupby: str = 'date') -> go.Figure:
    ...
    def create_metrics_cards(self, df: pd.DataFrame) -> dict[str, any]:
        ...
        unique_repos = df['repository_name'].nunique() if 'repository_name' in df.columns else 0
